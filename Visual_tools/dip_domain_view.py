...
xmin, xmax = np.min(top_surface[:, 1]), np.max(top_surface[:, 1])
ymin, ymax = np.min(top_surface[:, 2]), np.max(top_surface[:, 2])
zmin, zmax = np.min(bot_surface[:, 3]), np.max(top_surface[:, 3])
